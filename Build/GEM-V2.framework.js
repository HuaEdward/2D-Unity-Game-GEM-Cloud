...
var ASM_CONSTS = {
  4090704: function() {return Module.webglContextAttributes.premultipliedAlpha;},  
 4090765: function() {return Module.webglContextAttributes.preserveDrawingBuffer;},  
 4090829: function() {return Module.webglContextAttributes.powerPreference;},  
 4090887: function() {Module['emscripten_get_now_backup'] = performance.now;},  
 4090942: function($0) {performance.now = function() { return $0; };},  
 4090990: function($0) {performance.now = function() { return $0; };},  
 4091038: function() {performance.now = Module['emscripten_get_now_backup'];}
};
  ...
  function _PlayDeckBridge_PostMessage(method) {
  ...
  function _PlayDeckBridge_PostMessage_GetData(key) {
      const parent = window.parent.window;
      parent.postMessage(
  ...
  function _PlayDeckBridge_PostMessage_GetPaymentInfo(data) {
      const parent = window.parent.window;
  ...
  function _PlayDeckBridge_PostMessage_IntValue(method, value) {
      const parent = window.parent.window;
      parent.postMessage(
  ...
  function _PlayDeckBridge_PostMessage_RequestPayment(data) {
      const parent = window.parent.window;
      const jsonData = JSON.parse(UTF8ToString(data));
      console.log(jsonData);
      parent.postMessage(
  ...
  function _PlayDeckBridge_PostMessage_SetData(key, value) {
      const parent = window.parent.window;
      parent.postMessage(
  ...
  function _PlayDeckBridge_PostMessage_StringValue(method, value) {
      const parent = window.parent.window;
      parent.postMessage(
...
var asmLibraryArg = {
  ...
  "PlayDeckBridge_PostMessage": _PlayDeckBridge_PostMessage,
  "PlayDeckBridge_PostMessage_GetData": _PlayDeckBridge_PostMessage_GetData,
  "PlayDeckBridge_PostMessage_GetPaymentInfo": _PlayDeckBridge_PostMessage_GetPaymentInfo,
  "PlayDeckBridge_PostMessage_IntValue": _PlayDeckBridge_PostMessage_IntValue,
  "PlayDeckBridge_PostMessage_RequestPayment": _PlayDeckBridge_PostMessage_RequestPayment,
  "PlayDeckBridge_PostMessage_SetData": _PlayDeckBridge_PostMessage_SetData,
  "PlayDeckBridge_PostMessage_StringValue": _PlayDeckBridge_PostMessage_StringValue,
